...
4. Check the project's coding conventions from project convention files and registry context
...
### Step 5: Track Tasks Complete

Update the tasks artifact content — change `- [ ]` to `- [x]` for completed tasks:
...
- Mark tasks complete in the persisted tasks artifact AS you go, not at the end
